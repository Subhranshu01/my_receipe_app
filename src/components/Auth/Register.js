...
const Register = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-teal-400 via-blue-500 to-purple-600 p-4">
      <div className="bg-white p-8 md:p-10 rounded-xl shadow-xl w-full max-w-md border border-gray-200">
        <h2 className="text-2xl md:text-3xl font-extrabold mb-6 md:mb-8 text-center text-gray-800">Register</h2>
